...
public class JekyllWhereImpl extends WhereImpl {
    ...
    public static final PropertyResolverAdapter.Helper propertyRetrievalTypeAdapterHelper = new PropertyResolverAdapter.Helper();


    public JekyllWhereImpl(ObjectMapper mapper) {
        super(mapper, Flavor.JEKYLL);
    }
    ...
    */
    ...
    private Object itemProperty(Object e, Object property) {
        PropertyResolverAdapter adapter = propertyRetrievalTypeAdapterHelper.findFor(e);
        if (adapter != null) {
            return parseSortInput(adapter.getItemProperty(mapper, e, property));
        }
        return ((Map) e).get(property);
    }
